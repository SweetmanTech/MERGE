...
contract SplitHelpers is PureHelpers {
    ...
    /// @notice All Core Dev team who made The Merge happen.
    address public immutable coreDevs;
    /// @notice SongaDAO.
    address public immutable songaDAO;
    /// @notice sweetman.eth.
    address public immutable engineer =
...
ftContract;
    ...
    constructor(
        ...
        /// Establish All Core Dev team (25%)
        coreDevs = _coreDevs;
        /// Establish songaDAO (50%)
        songaDAO = _songaDAO;
        /// Establish NFT holder contract
        nftContract = IERC721(_nftContractAddress);
        /// Establish tokenIds from NFT contract for split recipients (25%).
        tokenIds = _tokenIds;
